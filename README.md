...
* doc 用户信息文档，可以只提供需要修改的字段


## 找回密码：得到安全问题 - retrieve

客户端首先需要取得安全问题，仅传给服务器username参数，服务器返回该用户设置的安全问题
...
* 200 请求完成，并返回 question 字段
* 404 用户名不存在
* 405 用户没有设置安全问题，无法找回密码


## 找回密码：提供安全问题的答案，并重设密码 - retrieve
